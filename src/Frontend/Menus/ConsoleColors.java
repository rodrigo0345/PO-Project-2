...
public class ConsoleColors {
    ...
    public String getBLACK_BOLD() {
        return BLACK_BOLD;
    }

    public String getRED_BOLD() {
        return RED_BOLD;
    }

    public String getGREEN_BOLD() {
        return GREEN_BOLD;
    }

    public String getYELLOW_BOLD() {
        return YELLOW_BOLD;
    }

    public String getBLUE_BOLD() {
        return BLUE_BOLD;
    }

    public String getPURPLE_BOLD() {
        return PURPLE_BOLD;
    }

    public String getCYAN_BOLD() {
        return CYAN_BOLD;
    }

    public String getWHITE_BOLD() {
        return WHITE_BOLD;
    }

    public String getBLACK_UNDERLINED() {
        return BLACK_UNDERLINED;
    }

    public String getRED_UNDERLINED() {
    ...
    public String getYELLOW_UNDERLINED() {
        return YELLOW_UNDERLINED;
    }

    public String getBLUE_UNDERLINED() {
        return BLUE_UNDERLINED;
    }

    public String getPURPLE_UNDERLINED() {
        return PURPLE_UNDERLINED;
    }

    public String getCYAN_UNDERLINED() {
        return CYAN_UNDERLINED;
    }

    public String getWHITE_UNDERLINED() {
    ...
    public String getBLACK_BRIGHT() {
        return BLACK_BRIGHT;
    }

    public String getRED_BRIGHT() {
        return RED_BRIGHT;
    }

    public String getGREEN_BRIGHT() {
        return GREEN_BRIGHT;
    }

    public String getYELLOW_BRIGHT() {
        return YELLOW_BRIGHT;
    }

    public String getBLUE_BRIGHT() {
        return BLUE_BRIGHT;
    }

    public String getPURPLE_BRIGHT() {
        return PURPLE_BRIGHT;
    }

    public String getCYAN_BRIGHT() {
        return CYAN_BRIGHT;
    }

    public String getWHITE_BRIGHT() {
        return WHITE_BRIGHT;
    }

    public String getBLACK_BOLD_BRIGHT() {
        return BLACK_BOLD_BRIGHT;
    }

    public String getRED_BOLD_BRIGHT() {
        return RED_BOLD_BRIGHT;
    }

    public String getGREEN_BOLD_BRIGHT() {
        return GREEN_BOLD_BRIGHT;
    }

    public String getYELLOW_BOLD_BRIGHT() {
        return YELLOW_BOLD_BRIGHT;
    }

    public String getBLUE_BOLD_BRIGHT() {
        return BLUE_BOLD_BRIGHT;
    }

    public String getPURPLE_BOLD_BRIGHT() {
        return PURPLE_BOLD_BRIGHT;
    }

    public String getCYAN_BOLD_BRIGHT() {
        return CYAN_BOLD_BRIGHT;
    }

    public String getWHITE_BOLD_BRIGHT() {
        return WHITE_BOLD_BRIGHT;
    }

    public String getBLACK_BACKGROUND_BRIGHT() {
        return BLACK_BACKGROUND_BRIGHT;
    }

    public String getRED_BACKGROUND_BRIGHT() {
        return RED_BACKGROUND_BRIGHT;
    }

    public String getGREEN_BACKGROUND_BRIGHT() {
        return GREEN_BACKGROUND_BRIGHT;
    }

    public String getYELLOW_BACKGROUND_BRIGHT() {
        return YELLOW_BACKGROUND_BRIGHT;
    }

    public String getBLUE_BACKGROUND_BRIGHT() {
        return BLUE_BACKGROUND_BRIGHT;
    }

    public String getPURPLE_BACKGROUND_BRIGHT() {
        return PURPLE_BACKGROUND_BRIGHT;
    }

    public String getCYAN_BACKGROUND_BRIGHT() {
        return CYAN_BACKGROUND_BRIGHT;
    }

    public String getWHITE_BACKGROUND_BRIGHT() {
